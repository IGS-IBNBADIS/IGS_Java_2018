...
public class StockModificateur extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					StockModificateur frame = new StockModificateur("",null,0,0);
	 ...
	 * Create the frame.
	 */
	public StockModificateur(String champ, DefaultTableModel model, int row, int column) {
